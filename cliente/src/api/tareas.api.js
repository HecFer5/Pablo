...
export const ListarInactivos = async () =>
  ...
  await axios.get("http://localhost:4001/pacientes");
...
// export const EditaSesion = async (idpaciente) =>
//   await axios.get("http://localhost:4001/sesiones/" + idpaciente);
...
export const TurnoMax = async (pacienteid) =>
  await axios.get("http://localhost:4000/turnomax/" + pacienteid);
...
export const CrearHistorias = async (historia) =>
  await axios.post("http://localhost:4001/historias", historia);
